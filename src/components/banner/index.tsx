        ...
        <div className="relative">
          <div className="max-sm:w-[calc(308*var(--scale))] max-sm:h-[calc(200*var(--scale))] max-sm:ml-[calc(-22*var(--scale))] max-md:w-[calc(653*var(--scale))] max-md:h-[calc(362*var(--scale))] max-lg:w-[calc(767*var(--scale))] max-lg:h-[calc(405*var(--scale))] w-[calc(1200*var(--scale))] h-[calc(632*var(--scale))] relative">
            <Image
              ...
              height={1899}
            />
            <div className="max-sm:hidden max-md:w-[calc(588*var(--scale))] max-md:h-[calc(268*var(--scale))] max-md:bottom-[calc(-29*var(--scale))] max-md:left-[calc(-29*var(--scale))] max-lg:w-[calc(760*var(--scale))] max-lg:h-[calc(347*var(--scale))] max-lg:bottom-[calc(-46*var(--scale))] max-lg:left-[calc(-44*var(--scale))] w-full h-[calc(542*var(--scale))] bg-black absolute bottom-[calc(-72*var(--scale))] left-[calc(-75*var(--scale))] -z-10"></div>
          </div>
          <div
            className="max-sm:w-[calc(331*var(--scale))] max-sm:gap-[calc(11*var(--scale)) max-sm:relative max-sm:mt-[calc(-90*var(--scale))] max-sm:ml-0 max-sm:top-0 max-sm:left-0 max-sm:right-0 max-sm:bottom-0
          max-md:w-[calc(651*var(--scale))] max-md:bottom-[calc(-180*var(--scale))] max-md:gap-[calc(20*var(--scale))]
          max-lg:w-[calc(465*var(--scale))] max-lg:bottom-[calc(-90*var(--scale))] max-lg:gap-[calc(20*var(--scale))] absolute right-0 w-[calc(668*var(--scale))] bottom-[calc(-40*var(--scale))] flex flex-col gap-[calc(35*var(--scale))]"
          >
            <Image
              src={iconUrl}
            ...
            <div
              className={`max-sm:top-[calc(35*var(--scale))] max-sm:w-[calc(99*var(--scale))] max-md:w-[calc(124*var(--scale))] max-md:h-[calc(72*var(--scale))] max-md:top-[calc(42*var(--scale))] max-md:right-[calc(60*var(--scale))] max-lg:w-[calc(124*var(--scale))] max-lg:h-[calc(72*var(--scale))] max-lg:top-[calc(61*var(--scale))] max-lg:right-[calc(74*var(--scale))] absolute w-[calc(195*var(--scale))] h-[calc(112*var(--scale))] top-[calc(96*var(--scale))] ${
