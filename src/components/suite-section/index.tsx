...
const SuiteSection = async ({ page }: SuiteSectionProps) => {
  ...
  return (
    <section className="max-sm:mt-[calc(26*var(--scale))] overflow-x-clip">
      <div className="max-sm:p-[calc(20*var(--scale))calc(22*var(--scale))] max-sm:pb-[calc(85*var(--scale))] max-lg:p-[calc(24*var(--scale))calc(80*var(--scale))] p-[calc(50*var(--scale))calc(125*var(--scale))] w-full max-w-[calc(1600*var(--scale))] m-auto">
        <div className="max-sm:before:w-[calc(100%+14px)] max-sm:before:left-[50%] max-sm:before:h-[calc(298*var(--scale))] max-sm:before:top-[calc(-20*var(--scale))] max-sm:before:-translate-x-[50%] max-lg:before:w-[calc(828*var(--scale))] max-lg:before:h-[calc(400*var(--scale))] max-lg:before:top-[calc(-60*var(--scale))] relative before:content-[''] before:absolute before:bg-black before:w-[calc(1247*var(--scale))] before:h-[calc(735*var(--scale))] before:top-[calc(-91*var(--scale))] before:left-[calc(-125*var(--scale))] before:-z-10">
          <div className="max-sm:flex-col max-sm:gap-[calc(9*var(--scale))] max-sm:px-[calc(14*var(--scale))] max-md:mb-[calc(37*var(--scale))] max-lg:gap-[calc(33*var(--scale))] max-lg:mb-[calc(47*var(--scale))] flex text-white gap-[calc(53*var(--scale))] mb-[calc(80*var(--scale))]">
            ...
            <div>
              <p className="max-md:max-w-[calc(417*var(--scale))] max-lg:max-w-[calc(450*var(--scale))] max-lg:leading-[1.5] text-[calc(1*var(--size-20))] mb-[calc(24*var(--scale))] leading-[1.7] max-w-[calc(725*var(--scale))]">
                {text}
              </p>
          ...
          <div className="max-sm:before:left-[50%] max-sm:before:w-[117.5%] max-sm:before:bottom-[calc(-30*var(--scale))] max-sm:before:top-[initial] max-sm:before:h-[calc(630*var(--scale))] max-sm:before:-translate-x-[50%] max-md:gap-[calc(65*var(--scale))] max-lg:before:h-[calc(770*var(--scale))] max-lg:before:bottom-[calc(-28*var(--scale))] max-lg:before:top-[initial] max-lg:before:w-[114%] max-lg:gap-[calc(33*var(--scale))] relative flex flex-col gap-[calc(56*var(--scale))] before:content-[''] before:absolute before:bg-[#e7e2e0] before:w-[calc(1517*var(--scale))] before:h-[calc(1117*var(--scale))] before:top-[calc(-91*var(--scale))] before:left-[calc(-43*var(--scale))] before:-z-20">
            <div className="max-sm:left-[calc(-28*var(--scale))] max-sm:h-[calc(200*var(--scale))] max-sm:w-[calc(323*var(--scale))] max-lg:h-[calc(404*var(--scale))] h-[calc(560*var(--scale))] w-full relative">
              <ScrollImage
              ...
              <Image
                ...
                fill={true}
              />
              <div className="max-sm:w-[calc(66*var(--scale))] max-sm:h-[calc(66*var(--scale))] max-sm:right-[calc(-31*var(--scale))] max-sm:top-[calc(16*var(--scale))] max-lg:w-[calc(82*var(--scale))] max-lg:h-[calc(81*var(--scale))] max-lg:top-[calc(-33*var(--scale))] flex justify-center items-center absolute w-[calc(117*var(--scale))] h-[calc(115*var(--scale))] top-[calc(-45*var(--scale))] right-[calc(37*var(--scale))] z-10 bg-white">
                <Image
                  src={iconUrl}
            ...
            <div className="max-sm:mb-0 max-sm:gap-[calc(8*var(--scale))] max-lg:h-[calc(230*var(--scale))] h-[calc(358*var(--scale))] w-[109%] mt-auto flex items-end z-10">
