            ...
            >
              ...
              <>
                {Array(
                  ...
                  ?.map((card, i) => {
                    const firstCard =
                      response?.viewpoint_cards?.data[firstPost];
                    const secondCard =
                      response?.viewpoint_cards?.data[secondPost];
                    const thirdCard =
                      response?.viewpoint_cards?.data[thirdPost];
                    const fourthCard =
                      response?.viewpoint_cards?.data[fourthPost];
                    const fifthCard =
                      response?.viewpoint_cards?.data[fifthPost];
                          ...
                          <div className="flex flex-col gap-3 phablet:gap-4 tablet:flex-row tablet:gap-3 desktop:gap-6 w-full">
                            {firstCard?.attributes?.title?.length > 0 ? (
                              <div
                                ...
                                onClick={() => {
                                  if (
                                    firstCard?.attributes?.mediaType === "image"
                                  ) {
                                    router.push(
                            ...
                            {secondCard?.attributes?.title?.length > 0 ? (
                              <div
                                ...
                                onClick={() => {
                                  if (
                                    secondCard?.attributes?.mediaType ===
                                    "image"
                                  ) {
                                    router.push(
                          ...
                          <div className="hidden desktop:flex gap-6 w-full">
                            {thirdCard?.attributes?.title?.length > 0 ? (
                              <div
                                ...
                                onClick={() => {
                                  if (
                                    thirdCard?.attributes?.mediaType === "image"
                                  ) {
                                    router.push(
                            ...
                            <div className="flex flex-col flex-[8] gap-6">
                              {fourthCard?.attributes?.title?.length > 0 ? (
                                <div
                                  ...
                                  onClick={() => {
                                    if (
                                      fourthCard?.attributes?.mediaType ===
                                      "image"
                                    ) {
                                      router.push(
                                ...
                                >
                                  ...
                                  <MediaCard
                                    ...
                                    thumbnail={
                                      fourthCard?.attributes?.thumbnail
                                    }
                                    href={
                              ...
                              {fifthCard?.attributes?.title?.length > 0 ? (
                                <div
                                  ...
                                  onClick={() => {
                                    if (
                                      fifthCard?.attributes?.mediaType ===
                                      "image"
                                    ) {
                                      router.push(
