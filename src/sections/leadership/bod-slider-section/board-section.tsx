...
const BodSliderSection = ({ cards, content }: { cards: any; content: any }) => {
  ...
  return (
    <section
      ...
      max-sm:before:h-[calc(458*var(--scale))] max-sm:before:w-full max-md:before:w-[calc(588*var(--scale))] max-md:before:h-[calc(457*var(--scale))] max-md:before:left-0 max-md:before:top-[inherit] max-md:before:bottom-0 max-lg:before:h-full before:content-[''] before:-z-10 before:absolute before:left-0 before:top-0 before:h-full ${
        activeSlideId > -1
