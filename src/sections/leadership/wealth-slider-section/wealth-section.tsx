...
const WealthSliderSection = ({
  ...
  return (
    ...
    >
      ...
      <div className="max-sm:w-[calc(13*var(--scale))] max-sm:h-[calc(105*var(--scale))] max-md:w-[calc(15*var(--scale))] max-md:h-[calc(124*var(--scale))] max-lg:w-[calc(15*var(--scale))] max-lg:h-[calc(100*var(--scale))] w-[calc(40*var(--scale))] h-[calc(245*var(--scale))] bg-white absolute top-[50%] right-0 -translate-y-[50%]"></div>
    </section>
  );
};
