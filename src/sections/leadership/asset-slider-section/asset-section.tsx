...
const AssetSliderSection = ({
  ...
  return (
    ...
    max-sm:before:w-full max-md:before:w-[calc(620*var(--scale))] max-lg:before:w-[calc(428*var(--scale))] before:bg-asset-purple before:w-[calc(1061*var(--scale))] before:left-0 before:-z-10 before:content-[''] before:absolute before:top-0 before:h-full
    max-md:after:hidden max-lg:after:w-[calc(40*var(--scale))] max-lg:after:h-[calc(40*var(--scale))] max-lg:after:top-[calc(-40*var(--scale))] max-lg:after:left-[calc(428*var(--scale))] after:content-[''] after:bg-asset-purple after:absolute after:bottom-[calc(-60*var(--scale))] after:w-[calc(60*var(--scale))] after:left-[calc(1061*var(--scale))] after:h-[calc(60*var(--scale))] after:z-20
   "
    >
      <div className="max-sm:w-full max-md:w-full max-md:pl-[14px] max-lg:w-[71%] w-[65.2%]">
        <SliderSection
      ...
      <div className="max-md:mr-auto max-md:w-full max-md:max-w-[calc(532*var(--scale))] h-full flex-1 select-none">
      ...
      <div className="max-sm:hidden max-md:w-[calc(11*var(--scale))] max-md:h-[calc(80*var(--scale))] max-md:top-[calc(129*var(--scale))] max-lg:w-[calc(16*var(--scale))] max-lg:h-[calc(107*var(--scale))] max-lg:top-[calc(131*var(--scale))] max-lg:translate-x-0 max-lg:translate-y-0 w-[calc(40*var(--scale))] h-[calc(245*var(--scale))] bg-white absolute top-[50%] left-0 -translate-y-[50%]"></div>
    </section>
  );
};
