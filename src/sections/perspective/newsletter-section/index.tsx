...
const Newsletter = () => {
  return (
    <section className="bg-black">
      <div className="flex flex-col tablet:flex-row tablet:flex-1 pt-6 phablet:pt-12 tablet:pt-20 desktop:pt-32 tablet:container">
        ...
        <div className="bg-[#FD7740] p-6 phablet:p-12 tablet:p-16 desktop:p-24 tablet:flex-[7]">
          ...
          <div className="font-normal text-white text-base tablet:text-lg mt-2 mb-7 phablet:mt-3 tablet:mb-12 desktop:mt-5 desktop:mb-[72px]">
            ...
            insights from industry thought leaders, powerful commentary on
            leading media platforms, informative publications, and more.
          </div>
