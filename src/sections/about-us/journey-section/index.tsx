...
const JourneySection = async () => {
  ...
  return (
    <section className="max-sm:before:w-full relative before:content-[''] before:absolute before:w-[96%] before:h-[100%] before:top-0 before:left-0 before:bg-black before:-z-10">
      <div className="max-sm:px-[calc(28*var(--scale))] max-sm:pt-[calc(45*var(--scale))] max-sm:pb-[calc(34*var(--scale))] max-lg:px-[calc(80*var(--scale))] max-lg:pt-[calc(75*var(--scale))] max-lg:pb-[calc(36*var(--scale))] px-[calc(117*var(--scale))] pt-[calc(126*var(--scale))] pb-[calc(48*var(--scale))] w-full max-w-[calc(1600*var(--scale))] m-auto">
        ...
        <div className="max-sm:flex-col max-md:w-[91%] flex justify-between items-start w-full">
          <p className="max-sm:mb-[calc(30*var(--scale))] max-md:text-[calc(14*var(--scale))] max-md:max-w-[calc(450*var(--scale))] max-lg:max-w-[calc(590*var(--scale))] max-lg:mb-[calc(31*var(--scale))] text-[calc(1*var(--size-20))] text-white leading-[1.7] max-w-[calc(893*var(--scale))] mb-[calc(47*var(--scale))]">
            {text}
          </p>
        ...
        <div className="max-sm:ml-[calc(-27*var(--scale))] max-sm:w-[calc(100%+(calc(27*var(--scale))*2))] max-md:h-[calc(288*var(--scale))] max-lg:h-[calc(384*var(--scale))] max-lg:w-[109.5%] h-[calc(600*var(--scale))] w-[108.55%] relative bg-black">
          <video
