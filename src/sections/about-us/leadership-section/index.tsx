...
const LeadershipSection = async () => {
  ...
  return (
    <section
      className="max-sm:before:left-0 max-md:before:left-[3.4%] max-lg:mb-[calc(40*var(--scale))] relative overflow-hidden mb-[calc(84*var(--scale))] 
                before:absolute before:content-[''] before:w-full before:h-full before:bg-[#f2f0ef] before:-z-10 before:left-[7.9%]"
    >
      <div className="max-sm:p-[calc(48*var(--scale))calc(28*var(--scale))] max-md:p-[calc(48*var(--scale))calc(28*var(--scale))] max-lg:p-[calc(48*var(--scale))calc(80*var(--scale))] p-[calc(48*var(--scale))calc(126*var(--scale))] w-full max-w-[calc(1600*var(--scale))] m-auto">
        <div className="flex flex-col items-end">
          <h2 className="max-sm:ml-0 max-sm:mb-[calc(8*var(--scale))] max-md:ml-[calc(23*var(--scale))] max-lg:mb-[calc(4*var(--scale))] max-lg:ml-[calc(62*var(--scale))] max-lg:leading-[1.17] max-lg:tracking-[calc(-0.9*var(--scale))] text-[calc(1*var(--size-38))] mr-auto mb-[calc(8*var(--scale))] ml-[calc(98*var(--scale))] font-bold text-black tracking-[calc(-0.9*var(--scale))]">
            {title}
          </h2>
