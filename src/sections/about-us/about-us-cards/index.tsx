...
const AboutUsCards = ({ cards }: AboutUsCardsProps) => {
  ...
  return (
    <div className="max-sm:flex max-sm:flex-col max-sm:gap-y-[calc(17*var(--scale))] max-lg:gap-y-[calc(40*var(--scale))] flex-1 grid grid-cols-2 grid-rows-2 place-items-center gap-y-[calc(71*var(--scale))] py-[calc(10*var(--scale))]">
      {cardsList.map((card: any, index: number) => {
        ...
        return (
          <div
            key={card.title}
            className={`max-sm:flex-row max-sm:gap-[calc(21*var(--scale))] max-sm:items-start max-sm:p-0 max-lg:px-[calc(17*var(--scale))] max-lg:justify-start max-lg:before:h-[85%] max-lg:after:w-[65%] w-full h-full relative flex flex-col items-center justify-center px-[calc(84*var(--scale))]
          ...
          >
            <div className="max-sm:h-[calc(40*var(--scale))] max-sm:w-[calc(40*var(--scale))] max-sm:mb-[calc(13*var(--scale))] max-lg:w-[calc(30.7*var(--scale))] max-lg:h-[calc(30.7*var(--scale))] max-lg:mb-[calc(17*var(--scale))] w-[calc(50*var(--scale))] h-[calc(50*var(--scale))] mb-[calc(28*var(--scale))]">
              <Image
            ...
            <div className="max-sm:flex-1 max-sm:relative">
              <h5 className="max-sm:text-left max-sm:text-[calc(16*var(--scale))] max-sm:leading-[1.51] max-lg:whitespace-nowrap max-lg: leading-[2.2] text-[calc(1*var(--size-20))] text-center font-bold">
                {card.title}
              </h5>
