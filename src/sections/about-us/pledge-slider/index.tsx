            ...
            return (
              <div
                ...
                className={`transition-all duration-500 ease-[ease] delay-0 ${
                  index === firstIndex
                    ? "max-sm:w-full max-sm:mr-0 max-sm:h-[calc(399*var(--scale))] max-md:mr-[calc(9.7*var(--scale))] max-md:w-[calc(652*var(--scale))] max-md:h-[calc(378*var(--scale))] max-lg:w-[calc(542*var(--scale))] max-lg:h-[calc(416*var(--scale))] w-[calc(796*var(--scale))] h-[calc(702*var(--scale))] mr-[calc(17*var(--scale))]"
